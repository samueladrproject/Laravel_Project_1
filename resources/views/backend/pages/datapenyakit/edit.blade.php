                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('namapenyakit') is-invalid @enderror"
                                    ...
                                    value="{{ old('namapenyakit') == null ? $dataPenyakit->nama_penyakit : old('namapenyakit') }}">
                                @error('namapenyakit')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('detailpenyakit') is-invalid @enderror" rows="3"
                                    ...
                                    name="detailpenyakit">{{ old('detailpenyakit') == null ? $dataPenyakit->detail_penyakit : old('detailpenyakit') }}</textarea>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('saranpenyakit') is-invalid @enderror" rows="3"
                                    ...
                                    name="saranpenyakit">{{ old('saranpenyakit') == null ? $dataPenyakit->saran_penyakit : old('saranpenyakit') }}</textarea>
                                @error('saranpenyakit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
