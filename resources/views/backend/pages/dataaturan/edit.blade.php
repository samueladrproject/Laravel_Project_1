        ...
        <div class="col-xl col-lg">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                    <h6 class="m-0 font-weight-bold text-white">Edit {{ $titlePage }}</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ URL::to('/data-aturan' . '/' . $dataAturan->id_aturan) }}" method="POST"
                            ...
                            <div class="col-sm-10">
                                <select class="form-select @error('namapenyakit') is-invalid @enderror" id="namapenyakit"
                                    ...
                                    @if (old('namapenyakit') == null)
                                        @if ($dataAturan->nama_penyakit)
                                            <option disabled>Open this select menu</option>
                                            @foreach ($dataPenyakit as $penyakit)
                                                <option value="{{ $penyakit->nama_penyakit }}"
                                                    {{ $dataAturan->nama_penyakit == $penyakit->nama_penyakit ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-10">
                                <select class="form-select @error('namagejala') is-invalid @enderror" id="namagejala"
                                    ...
                                    @if (old('namagejala') == null)
                                        @if ($dataAturan->nama_gejala)
                                            <option disabled>Open this select menu</option>
                                            @foreach ($dataGejala as $gejala)
                                                <option value="{{ $gejala->nama_gejala }}"
                                                    {{ $dataAturan->nama_gejala == $gejala->nama_gejala ? 'selected' : '' }}>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('nilaimb') is-invalid @enderror"
                                    id="nilaimb" name="nilaimb"
                                    value="{{ old('nilaimb') == null ? $dataAturan->nilai_MB : old('nilaimb') }}"
                                    step=".01">
                                @error('nilaimb')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('nilaimd') is-invalid @enderror"
                                    id="nilaimd" name="nilaimd"
                                    value="{{ old('nilaimd') == null ? $dataAturan->nilai_MD : old('nilaimd') }}" step="
                                                .01">
                                @error('nilaimd')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button class="btn btn-secondary mr-md-2" type="reset"><i class="fas fa-ban mr-1"></i> Reset
                                Forms</button>
                            <button class="btn btn-primary" type="submit"><i class="fas fa-save mr-1"></i> Update
                                Data</button>
                        </div>
                    </form>
                </div>
